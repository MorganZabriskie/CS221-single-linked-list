 ...
 * get you started.
 * 
 * @author mvail, mhthomas, awinters, mzabriskie
 */
...
//			break;
	...
	/**
	 * Scenario: [A] -> iter remove(A) -> []
	 * 
	 * @return [] after iter remove(A)
	 */
	...
	/**
	 * Scenario: [A,B] -> iter remove(A) -> [B]
	 * 
	 * @return [B] after iter remove(A)
	 */
	...
	/**
	 * Scenario: [A,B] -> iter remove(B) -> [A]
	 * 
	 * @return [A] after iter remove(B)
	 */
	...
	private void testEmptyList(Scenario<Integer> scenario, String scenarioName) {
		...
		try {
			...
			printTest(scenarioName + "_testRemoveIndexNeg1", testRemoveIndex(scenario.build(), -1, null, Result.IndexOutOfBounds));
			printTest(scenarioName + "_testRemoveIndex0", testRemoveIndex(scenario.build(), 0, null, Result.IndexOutOfBounds));
			// Iterator
	...
	private void testSingleElementList(Scenario<Integer> scenario, String scenarioName, Integer[] contents, String contentsString) {
		...
		try {
			...
			printTest(scenarioName + "_testIndexOfX", testIndexOf(scenario.build(), ELEMENT_X, -1));
			printTest(scenarioName + "_testRemoveIndexNeg1", testRemoveIndex(scenario.build(), -1, null, Result.IndexOutOfBounds));
			printTest(scenarioName + "_testRemoveIndex0", testRemoveIndex(scenario.build(), 0, contents[0], Result.MatchingValue));
			printTest(scenarioName + "_testRemoveIndex1", testRemoveIndex(scenario.build(), 1, null, Result.IndexOutOfBounds));
			// Iterator
			printTest(scenarioName + "_testIter", testIter(scenario.build(), Result.NoException));
	...
	private void testTwoElementList(Scenario<Integer> scenario, String scenarioName, Integer[] contents, String contentsString) {
		...
		try {
			...
			printTest(scenarioName + "_testRemove0" + contentsString.charAt(0), testRemoveElement(scenario.build(), contents[0], Result.MatchingValue));
			printTest(scenarioName + "_testRemove1" + contentsString.charAt(1), testRemoveElement(scenario.build(), contents[1], Result.MatchingValue));
			printTest(scenarioName + "_testRemoveX", testRemoveElement(scenario.build(), ELEMENT_X, Result.NoSuchElement));
			printTest(scenarioName + "_testFirst", testFirst(scenario.build(), contents[0], Result.MatchingValue));
			...
			printTest(scenarioName + "_testRemoveIndexNeg1", testRemoveIndex(scenario.build(), -1, null, Result.IndexOutOfBounds));
			printTest(scenarioName + "_testRemoveIndex0", testRemoveIndex(scenario.build(), 0, contents[0], Result.MatchingValue));
			printTest(scenarioName + "_testRemoveIndex1", testRemoveIndex(scenario.build(), 1, contents[1], Result.MatchingValue));
			printTest(scenarioName + "_testRemoveIndex2", testRemoveIndex(scenario.build(), 2, null, Result.IndexOutOfBounds));
			// Iterator
			printTest(scenarioName + "_testIter", testIter(scenario.build(), Result.NoException));
			printTest(scenarioName + "_testIterHasNext", testIterHasNext(scenario.build().iterator(), Result.True));
			printTest(scenarioName + "_testIterNext", testIterNext(scenario.build().iterator(), contents[0], Result.MatchingValue));
			...
			printTest(scenarioName + "_iterNextRemoveNext_testIterHasNext", testIterHasNext((iterAfterRemoveAndNext(iterAfterNext(scenario.build(), 1))), Result.False));
			printTest(scenarioName + "_iterNextRemoveNext_testIterNext", testIterNext(iterAfterRemoveAndNext(iterAfterNext(scenario.build(), 1)), null, Result.NoSuchElement));
			printTest(scenarioName + "_iterNextRemoveNext_testIterRemove", testIterRemove(iterAfterRemoveAndNext(iterAfterNext(scenario.build(), 1)), Result.NoException));
			// ListIterator
			if (SUPPORTS_LIST_ITERATOR) {
				//TODO: will add for double-linked list
			} else {
	...
	private void testThreeElementList(Scenario<Integer> scenario, String scenarioName, Integer[] contents, String contentsString) {
		...
		try {
			...
			printTest(scenarioName + "_testRemove0" + contentsString.charAt(0), testRemoveElement(scenario.build(), contents[0], Result.MatchingValue));
			printTest(scenarioName + "_testRemove1" + contentsString.charAt(1), testRemoveElement(scenario.build(), contents[1], Result.MatchingValue));
			printTest(scenarioName + "_testRemove2" + contentsString.charAt(2), testRemoveElement(scenario.build(), contents[2], Result.MatchingValue));
			printTest(scenarioName + "_testRemoveX", testRemoveElement(scenario.build(), ELEMENT_X, Result.NoSuchElement));
			printTest(scenarioName + "_testFirst", testFirst(scenario.build(), contents[0], Result.MatchingValue));
			...
			printTest(scenarioName + "_testRemoveIndex0", testRemoveIndex(scenario.build(), 0, contents[0], Result.MatchingValue));
			printTest(scenarioName + "_testRemoveIndex1", testRemoveIndex(scenario.build(), 1, contents[1], Result.MatchingValue));
			printTest(scenarioName + "_testRemoveIndex2", testRemoveIndex(scenario.build(), 2, contents[2], Result.MatchingValue));
			printTest(scenarioName + "_testRemoveIndex3", testRemoveIndex(scenario.build(), 3, null, Result.IndexOutOfBounds));
			// Iterator
			printTest(scenarioName + "_testIter", testIter(scenario.build(), Result.NoException));
			printTest(scenarioName + "_testIterHasNext", testIterHasNext(scenario.build().iterator(), Result.True));
			printTest(scenarioName + "_testIterNext", testIterNext(scenario.build().iterator(), contents[0], Result.MatchingValue));
			...
			printTest(scenarioName + "_iterNextNextNext_testIterRemove", testIterRemove(iterAfterNext(scenario.build(), 2), Result.NoException));
			...
			printTest(scenarioName + "_iterNextRemoveNext_testIterHasNext", testIterHasNext((iterAfterRemoveAndNext(iterAfterNext(scenario.build(), 1))), Result.True));
			printTest(scenarioName + "_iterNextRemoveNext_testIterNext", testIterNext(iterAfterRemoveAndNext(iterAfterNext(scenario.build(), 1)), contents[2], Result.MatchingValue));
			printTest(scenarioName + "_iterNextRemoveNext_testIterRemove", testIterRemove(iterAfterRemoveAndNext(iterAfterNext(scenario.build(), 1)), Result.NoException));
			printTest(scenarioName + "_iterNextNextRemoveNext_testIterHasNext", testIterHasNext(iterAfterRemoveAndNext(iterAfterNext(scenario.build(), 2)), Result.False));
			printTest(scenarioName + "_iterNextNextRemoveNext_testIterNext", testIterNext(iterAfterRemoveAndNext(iterAfterNext(scenario.build(), 2)), null, Result.NoSuchElement));
			printTest(scenarioName + "_iterNextNextRemoveNext_testIterRemove", testIterRemove(iterAfterRemoveAndNext(iterAfterNext(scenario.build(), 2)), Result.NoException));
			// ListIterator
			if (SUPPORTS_LIST_ITERATOR) {
				//TODO: will add for double-linked list
			} else {
	...
	/**
	 * Helper for testing iterators. Return an Iterator that has had remove() and next() 
	 * called once.
	 * 
	 * @param iterator
	 * @return same Iterator following a call to remove() and next()
	 */
	private Iterator<Integer> iterAfterRemoveAndNext(Iterator<Integer> iterator) {
		iterator.remove();
		iterator.next();
		return iterator;
	}
